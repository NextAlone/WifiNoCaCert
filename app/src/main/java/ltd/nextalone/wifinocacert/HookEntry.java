package ltd.nextalone.wifinocacert;

import static ltd.nextalone.wifinocacert.utils.LogUtilsKt.logDebug;
import static ltd.nextalone.wifinocacert.utils.LogUtilsKt.logDetail;
import static ltd.nextalone.wifinocacert.utils.LogUtilsKt.logError;
import static ltd.nextalone.wifinocacert.utils.LogUtilsKt.logThrowable;
import static ltd.nextalone.wifinocacert.utils.ReflectUtilsKt.iGetObjectOrNull;
...
import ltd.nextalone.wifinocacert.sdk30.SettingWifiConfigControllerHook;
...
public class HookEntry implements IXposedHookLoadPackage {
  ...
  private static void initializeHookInternal(LoadPackageParam lpparam) {
    ...
    try {
      ...
      SettingWifiConfigControllerHook.INSTANCE.initOnce();
    } catch (Exception e) {
      ...
      if (sModulePath == null) {
        ...
        for (Object element : dexElements) {
          ...
          if (file != null && !file.isDirectory()) {
            ...
            if (modulePath == null || !modulePath.contains("ltd.nextalone.wifinocacert")) {
              modulePath = path;
            }
          }
        }
  ...
  public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
    ...
    if ("com.google.android.settings".equals(lpparam.packageName)
